...
class PreMeasurementScreen extends StatelessWidget {
          ...
          children: [
            ...
            Text.rich(
              TextSpan(
                ...
                children: const [
                  TextSpan(text: 'This 8-minute process builds an avatar calibrated to '),
                  TextSpan(
                    text: 'YOUR',
                    style: TextStyle(fontWeight: FontWeight.w700),
                  ),
                  TextSpan(text: ' exact body — so every outfit DRAPE suggests actually fits you.'),
                ],
              ),
            ),
